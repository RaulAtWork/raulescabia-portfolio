    ...
    <section>
      ...
      <TimeLine>
        ...
        >
          ...
          spanning 46 countries with a complex database architecture, leveraging
          the <b>Gitflow workflow</b> like approach for version control. Played a
          key role in{" "}
        ...
        >
          ...
          Contributed to the creation of <span className="text-accent-color">responsive HTML and CSS templates</span>,
          supported <span className="text-accent-color">system design and architecture</span>, <span className="text-accent-color">SQL query calls</span>,
          and provided <b>training for new team members</b> to ensure smooth onboarding
